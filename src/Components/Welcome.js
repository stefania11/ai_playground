    ...
    return (
        <div>
            <div className="container d-flex justify-content-center">
                <img src="ai_playground/image/twoPpl.png" alt="Two people having a conversation" className="homepageMain"></img>
            </div>
            <div className="container d-flex welcomeSection justify-content-center">
                <img src="ai_playground/image/hpSide2.png" alt="Child playing with AI col-3" className="homepageSide2"></img>
            <div className="col-6">
