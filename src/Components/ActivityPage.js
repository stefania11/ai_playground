...
export function ActivityPageCoral(props) {
    return ( <
        ...
        <
        p style = {
            { color: 'grey' } } > { "Classification Game Instructions" } < /p> <
        /div> <
        /div>
        ...
        <
        p style = {
            { color: 'grey' } } > { "Anchor Game Instructions" } < /p> <
        /div> <
        /div>
        ...
        div className = 'd-flex flex-column' >
        <
        h2 > { "Share Your Ideas" } < /h2> { /* <textarea rows="10" cols="80"></textarea> */ } <
        br > < /br> <
        div >
        <
...
export function ActivityPageScavenger(props) {
    return ( <
        ...
        <
        p style = {
            { color: 'grey' } } > { "Machine Learning Game" } < /p> <
        /div> <
        /div>
...
export function ActivityPageDesign(props) {
    return ( <
        ...
        <
        p style = {
            { color: 'grey' } } > { "Analyze AI Worksheet" } < /p> <
        /div> <
        /div>
